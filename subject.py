...
class Subject:
    def __init__(self,root):
        self.root=root
        self.root.geometry("1267x700+0+0")
        ...
        img3 = img3.resize((1267, 700), PIL.Image.LANCZOS)
        self.photoimg3 = ImageTk.PhotoImage(img3)

        bg_img = Label(self.root, image=self.photoimg3)
        bg_img.place(x=0, y=0, width=1267, height=700)
        ...
        main_frame.place(x=23, y=90, width=1220, height=588)

        # =left_label
        self.getNextid()
        Left_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE,
                                font=("times new roman", 12, "bold"))
        Left_frame.place(x=10, y=5, width=1190, height=280)
        ...
        # nclass
        nameLabel = Label(left_inside_frame, text="Lớp học:", font=("times new roman", 11, "bold"),
                          bg="white")
        nameLabel.grid(row=2, column=0, padx=50, pady=10, sticky=W)

        nameLabel_entry = ttk.Combobox(left_inside_frame, width=20, textvariable=self.var_subclass,
                                    font=("times new roman", 11, "bold"))
        nameLabel_entry["values"] = class_array
        nameLabel_entry.current()
        nameLabel_entry.grid(row=2, column=1, padx=20, pady=10, sticky=W)
        
        # credit
        lbl_credit = Label(left_inside_frame, text="Số tín chỉ:", font=("times new roman", 11, "bold"),
                          bg="white")
        lbl_credit.grid(row=3, column=0, padx=50, pady=10, sticky=W)

        lbl_credit_entry = ttk.Entry(left_inside_frame, width=22, textvariable=self.var_subcredit,
                               font=("times new roman", 11, "bold"))
        lbl_credit_entry.grid(row=3, column=1, padx=20, pady=10, sticky=W)      

        # btn_frame

        btn_frame = Frame(left_inside_frame, bg="white")
        btn_frame.place(x=30, y=170, width=440, height=110)
        
        add_btn = Button(btn_frame, text="Thêm mới", command=self.add_data, font=("times new roman", 11, "bold"),
                         bg="#38a6f0", fg="white", width=9)
        add_btn.grid(row=9, column=0, pady=7, padx=5)

        delete_btn = Button(btn_frame, text="Xóa", command=self.delete_data,
                            font=("times new roman", 11, "bold"),
                            bg="#38a6f0", fg="white", width=9)
        delete_btn.grid(row=9, column=1, pady=7, padx=5)

        update_btn = Button(btn_frame, text="Cập nhật", command=self.update_data, font=("times new roman", 11, "bold"),
                            bg="#38a6f0", fg="white", width=9)
        update_btn.grid(row=9, column=2, pady=7, padx=5)

        reset_btn = Button(btn_frame, text="Làm mới", command=self.reset_data, font=("times new roman", 11, "bold"),
                           bg="#38a6f0", fg="white", width=9)
        reset_btn.grid(row=9, column=3, pady=7, padx=5)

        # right_ label
        Right_frame = LabelFrame(Left_frame, bg="white",bd=0,
                                 font=("times new roman", 12, "bold"))
        Right_frame.place(x=480, y=5, width=720, height=255)
        ...
        search_combo = ttk.Combobox(Right_frame, font=("times new roman", 11, "bold"), textvariable=self.var_com_search,
                                    state="read only",
                                    width=13)
        search_combo["values"] = ("ID Môn học", "Tên môn học", "Lớp học")
        ...
        table_frame.place(x=85, y=55, width=580, height=200)
        ...
        self.AttendanceReportTable.heading("credit", text="Số tín chỉ")

        self.AttendanceReportTable["show"] = "headings"
        self.AttendanceReportTable.column("id", width=100)
        self.AttendanceReportTable.column("name", width=100)
        self.AttendanceReportTable.column("class", width=100)
        self.AttendanceReportTable.column("credit", width=100)
        ...
        Underleft_frame.place(x=10, y=295, width=605, height=285)

        label_teachersb = Label(Underleft_frame, bg="white", fg="red2", text="Môn học của giáo viên",
                                 font=("times new roman", 12, "bold"))
        ...
        search_combo = ttk.Combobox(Underleft_frame, font=("times new roman", 12, "bold"), textvariable=self.var_com_searchtc,
                                    state="read only",
                                    width=12)
        search_combo["values"] = ("ID giáo viên", "ID môn học")
        search_combo.current(0)
        ...
        teacherid_label = Label(Underleft_frame, text="ID giáo viên:", font=("times new roman", 11, "bold"),
                                    bg="white",width=12)
        ...
        Underright_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE,
                                     font=("times new roman", 12, "bold"))
        Underright_frame.place(x=630, y=295, width=605, height=285)

        label_studentsb = Label(Underright_frame, bg="white", fg="red2", text="Môn học của Học sinh",
                                font=("times new roman", 12, "bold"))
        ...
        search_combo = ttk.Combobox(Underright_frame, font=("times new roman", 11, "bold"),
                                    ...
                                    state="read only",
                                    width=12)
        search_combo["values"] = ("ID Học sinh", "ID môn học")
        search_combo.current(0)
        search_combo.grid(row=0, column=0, padx=10, pady=40, sticky=W)
        ...
        studentid_label = Label(Underright_frame, text="ID Học sinh:", font=("times new roman", 11, "bold"),
                                bg="white", width=12)
        ...
        tablestd_frame.place(x=437, y=40, width=150, height=230)
        ...
        self.StudentTable.heading("studentid", text="ID Học sinh")
    ...
    def add_data(self):
        ...
        if self.var_subid.get()=="Select" or self.var_subclass.get()=="" or self.var_subname.get()=="" or self.var_subcredit.get()=="":
            ...
            try:
                ...
                my_cursor=conn.cursor()
                my_cursor.execute("insert into subject values(%s,%s,%s, %s)",(
                    self.var_subid.get(),
                    self.var_subname.get(),
                    self.var_subclass.get(),
                    self.var_subcredit.get(),
                ))
                conn.commit()
                self.fetch_data()
                self.reset_data()
    ...
    def update_data(self):
        ...
        for chc in ckclass:
            arrayClass.append(str(chc[0]))
        if self.var_subid.get()=="Select" or self.var_subname.get()=="" or self.var_subclass.get()=="" or self.var_subcredit.get()=="":
            messagebox.showerror("Error","Vui lòng nhập đầy đủ thông tin",parent=self.root)
        elif (self.var_subname.get() in arraySub):
            messagebox.showerror("Error", "Lớp học đã có môn học này! Vui lòng kiểm tra lại", parent=self.root)
        elif (self.var_subclass.get() not in arrayClass):
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host='localhost', user='root', password='', database='face_recognizer', port='3306')
                    my_cursor = conn.cursor()
                    my_cursor.execute("update subject set Subject_name=%s,Class=%s, credit=%s"
                                      " where Subject_id=%s",(
                                            self.var_subname.get(),
                                            self.var_subclass.get(),
                                            self.var_subid.get(),
    ...
    def add_Tcdata(self):
        ...
        if self.var_teachersub.get()=="" or self.var_subsub.get()=="" :
            ...
            messagebox.showerror("Error", "giáo viên đã có môn học này! Vui lòng kiểm tra lại", parent=self.root)

        elif(self.var_teachersub.get() not in arrayTeacher):
            messagebox.showerror("Error", "ID giáo viên không tồn tại! Vui lòng kiểm tra lại", parent=self.root)
            ...
            try:
                ...
                self.reset_Tcdata()
                conn.close()
                messagebox.showinfo("Thành công","Thêm thông tin môn học cho giáo viên thành công",parent=self.root)
            except Exception as es:
                messagebox.showerror("Error",f"Due To:{str(es)}",parent=self.root)
        ...
        if self.var_com_searchtc.get()=="" or self.var_searchtc.get()=="":
            ...
            try:
                conn = mysql.connector.connect(host='localhost', user='root', password='',
                                               database='face_recognizer', port='3306')
                my_cursor = conn.cursor()#"ID Điểm Danh", "Ngày", "ID Học sinh"
                if(self.var_com_searchtc.get()=="ID giáo viên"):
    ...
    def add_Stddata(self):
        ...
        if self.var_studentsub == "" or self.var_subsubst.get() == "":
            ...
            messagebox.showerror("Error", "Học sinh đã có môn học này! Vui lòng kiểm tra lại", parent=self.root)
        elif (self.var_studentsub.get() not in arrayStudent):
            messagebox.showerror("Error", "ID Học sinh không tồn tại! Vui lòng kiểm tra lại", parent=self.root)
            ...
            try:
                ...
                self.reset_Stddata()
                conn.close()
                messagebox.showinfo("Thành công", "Thêm thông tin môn học cho Học sinh thành công",
                                        parent=self.root)
            except Exception as es:
                messagebox.showerror("Error", f"Due To:{str(es)}", parent=self.root)
        ...
        if self.var_studentsub == "" or self.var_subsubst.get() == "":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    if not Update:
                        return
                messagebox.showinfo("Thành công", "Cập nhật thông tin môn học Học sinh thành công", parent=self.root)
                conn.commit()
                self.reset_Stddata()
                self.fetch_Stddata()
                conn.close()
            ...
            if self.var_com_searchstd.get() == "" or self.var_searchstd.get() == "":
                ...
                try:
                    conn = mysql.connector.connect(host='localhost', user='root', password='',
                                                   database='face_recognizer', port='3306')
                    my_cursor = conn.cursor()  # "ID Điểm Danh", "Ngày", "ID Học sinh"
                    if (self.var_com_searchstd.get() == "ID Học sinh"):
