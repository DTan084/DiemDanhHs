...
class Teacher:
    def __init__(self,root):
        ...
        # idgv
        auttendanceID_label = Label(left_inside_frame, text="ID giáo viên:",font=("times new roman", 12, "bold"),
                                    bg="white")
        ...
        table_frame.place(x=5, y=55, width=820, height=510)
        ...
        self.AttendanceReportTable.heading("id", text="ID giáo viên")

        self.AttendanceReportTable.heading("name", text="Tên giáo viên")
