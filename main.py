...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        #background
        print(value_from_p1)
        img3 = PIL.Image.open(r"ImageFaceDetect\bgd.jpg")
        ...
        self.heading = Label(self.root, text=self.txt, font=("times new roman", 20, "bold"), bg="white", fg="black",
                             bd=5, relief=FLAT)
        ...
        self.lblemail.place(x=1000, y=48, width=100, height=22)
        ...
        b2.place(x=137, y=438, width=160, height=160)

        #student
        img_btn2 = PIL.Image.open(r"ImageFaceDetect\student.png")
        img_btn2 = img_btn2.resize((70, 103), PIL.Image.LANCZOS)
        self.photobtn2 = ImageTk.PhotoImage(img_btn2)

        btn2 = Button(self.root, text="Học sinh", font=("times new roman", 16, "bold"),command=self.student_details, image=self.photobtn2,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        btn2.place(x=137, y=180, width=160, height=160)

        #nhan dien
        img_btn3 = PIL.Image.open(r"ImageFaceDetect\nhandien.png")
        img_btn3 = img_btn3.resize((70, 103), PIL.Image.LANCZOS)
        ...
        b3 = Button(self.root, text="Nhận diện", font=("times new roman", 16, "bold"),command=self.face_recognition ,image=self.photobtn3,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b3.place(x=427, y=180, width=160, height=160)

        #bao-cao
        img_btn4 = PIL.Image.open(r"ImageFaceDetect\ghichu.png")
        img_btn4 = img_btn4.resize((70, 103), PIL.Image.LANCZOS)
        self.photobtn4 = ImageTk.PhotoImage(img_btn4)

        b4 = Button(self.root, text="Báo cáo", font=("times new roman", 16, "bold"),command=self.attendance_data ,image=self.photobtn4,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b4.place(x=710, y=180, width=160, height=160)

        #monhoc
        img_btn5 = PIL.Image.open(r"ImageFaceDetect\book.png")
        img_btn5 = img_btn5.resize((70, 103), PIL.Image.LANCZOS)
        ...
        b5 = Button(self.root, text="Môn học", font=("times new roman", 16, "bold"),command=self.subject_data, image=self.photobtn5,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b5.place(x=994, y=180, width=160, height=160)

        #teacher
        img_btn6 = PIL.Image.open(r"ImageFaceDetect\teacher.png")
        img_btn6 = img_btn6.resize((70, 103), PIL.Image.LANCZOS)
        ...
        b6 = Button(self.root, text="Giáo viên", font=("times new roman", 16, "bold"),command=self.teacher_data, image=self.photobtn6,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b6.place(x=427, y=438, width=160, height=160)


        #Buoi hoc
        img_btn7 = PIL.Image.open(r"ImageFaceDetect\lesson.png")
        img_btn7 = img_btn7.resize((70, 103), PIL.Image.LANCZOS)
        ...
        b7 = Button(self.root, text="Buổi học", font=("times new roman", 16, "bold"),command=self.lesson_data, image=self.photobtn7,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b7.place(x=710, y=438, width=160, height=160)

        #XemAnh
        img_btn8 = PIL.Image.open(r"ImageFaceDetect\picture.png")
        img_btn8 = img_btn8.resize((70, 103), PIL.Image.LANCZOS)
        ...
        b8 = Button(self.root, text="Xem ảnh", font=("times new roman", 16, "bold"),command=self.open_img, image=self.photobtn8,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b8.place(x=994, y=438, width=160, height=160)
