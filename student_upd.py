...
class Student:
    def __init__(self,root):
        ...
        img3 = img3.resize((1290, 700), PIL.Image.LANCZOS)
        self.photoimg3 = ImageTk.PhotoImage(img3)

        bg_img = Label(self.root, image=self.photoimg3)
        bg_img.place(x=0, y=0, width=1290, height=700)
        ...
        main_frame.place(x=23, y=90, width=1300, height=588)

        #left_label
        self.getNextid()
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",font=("times new roman",12,"bold"))
        Left_frame.place(x=0,y=10,width=620,height=565)
        ...
        #course
        course_label = Label(current_course_frame, text="Hệ đào tạo", font=("times new roman", 11, "bold"), bg="white")
        ...
        #semester
        semester_label = Label(current_course_frame, text="Học kì", font=("times new roman", 11, "bold"), bg="white")
        ...
        #student_id
        studentID_label = Label(class_student_frame, text="ID Sinh Viên:", font=("times new roman", 11, "bold"), bg="white")
        studentID_label.grid(row=0, column=0, padx=10,pady=10, sticky=W)

        studentID_entry=ttk.Entry(class_student_frame,width=20,textvariable=self.var_std_id,font=("times new roman", 11, "bold"),state="disabled")
        studentID_entry.grid(row=0,column=1,padx=10,pady=10,sticky=W)

        #studentName
        studentName_label = Label(class_student_frame, text="Tên Sinh Viên:", font=("times new roman", 11, "bold"),
                                bg="white")
        studentName_label.grid(row=0, column=2, padx=10,pady=10, sticky=W)

        studentName_entry = ttk.Entry(class_student_frame, width=20,textvariable=self.var_std_name, font=("times new roman", 11, "bold"))
        ...
        class_div_entry = ttk.Combobox(class_student_frame, width=18,textvariable=self.var_div, font=("times new roman", 11, "bold"))
        ...
        email_entry = ttk.Entry(class_student_frame, width=20,textvariable=self.var_email, font=("times new roman", 11, "bold"))
        ...
        phone_entry = ttk.Entry(class_student_frame, width=20,textvariable=self.var_phone, font=("times new roman", 11, "bold"))
        ...
        address_entry = ttk.Entry(class_student_frame, width=20,textvariable=self.var_address ,font=("times new roman", 11, "bold"))
        ...
        save_btn=Button(btn_frame,text="Lưu",command=self.add_data,font=("times new roman",11,"bold"),bg="#38a6f0", fg="white",width=16)
        save_btn.grid(row=0,column=0)

        update_btn = Button(btn_frame, text="Sửa",command=self.update_data, font=("times new roman", 11, "bold"), bg="#38a6f0", fg="white", width=15)
        update_btn.grid(row=0, column=1)

        delete_btn = Button(btn_frame, text="Xóa",command=self.delete_data, font=("times new roman", 11, "bold"), bg="#38a6f0", fg="white", width=16)
        delete_btn.grid(row=0, column=2)

        reset_btn = Button(btn_frame, text="Làm mới",command=self.reset_data, font=("times new roman", 11, "bold"), bg="#38a6f0", fg="white", width=15)
        reset_btn.grid(row=0, column=3)

        btn_frame1 = Frame(class_student_frame, bd=2, relief=RIDGE, bg="white")
        btn_frame1.place(x=0, y=335, width=715, height=35)

        take_photo_btn = Button(btn_frame1, text="Lấy ảnh sinh viên",command=self.generate_dataset, font=("times new roman", 11, "bold"), bg="#38a6f0", fg="white",
                           width=32)
        take_photo_btn.grid(row=1, column=0)
        self.trainer = Train()
        update_photo_btn = Button(btn_frame1, text="Training Data",command=self.trainer.train_classifier, font=("times new roman", 11, "bold"), bg="#38a6f0", fg="white",
                                width=32)
        ...
        Right_frame = LabelFrame(main_frame, bd=2, bg="white",
                                font=("times new roman", 12, "bold"))
        Right_frame.place(x=615, y=10, width=610, height=290)
        ...
        search_btn = Button(search_frame, text="Tìm kiếm", font=("times new roman", 11, "bold"),bg="#38a6f0", fg="white", width=12,command=self.search_data)
        search_btn.grid(row=0, column=3,padx=4)

        showAll_btn = Button(search_frame, text="Xem tất cả", font=("times new roman", 11, "bold"), bg="#38a6f0", fg="white",
        ...
        Underright_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE,
                                      font=("times new roman", 11, "bold"))
        Underright_frame.place(x=615, y=300, width=610, height=300)
        ...
        btn_framestd.place(x=15, y=200, width=395, height=55)
        ...
        if self.var_dep.get()=="Chọn chuyên ngành" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                while True:
                    ...
                    if cv2.waitKey(1)==13 or int(img_id)==100: #duyet du 120 anh
                        break
                cap.release()
